...
//可以攻击我方近战塔和远程塔的地面敌人 type = 3
EnemySuper::EnemySuper(const vector<Pos_t>& _path, Map *map, vector<Tower *>& tower_all):
...
void EnemySuper::attack_tower(vector<Tower *>& tower2attack) {
